...
/*
 * Case 8 : Default constructor; addPassenger, addFlight, saveFreeTicketRequest; executeTheFlight; print.
 */
int main() {
    ...
    std::cout << "-> Completing boarding for all flights and letting them fly." << std::endl;
